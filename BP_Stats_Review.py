...
Countries = file[~file['Million tonnes oil equivalent'].str.startswith('Total')].iloc[:-9].sort_values(['Million tonnes oil equivalent'])

#Find only the Total values
Total_Countries = file[file['Million tonnes oil equivalent'].str.startswith('Total')].sort_values(['Million tonnes oil equivalent'])
